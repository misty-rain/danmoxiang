package com.hg.danmoxiang_rrmvp.ui.widget.Calendar;
...
//        recyclerView.addItemDecoration(dividerItemDecoration);
        ...
        recyclerView.addItemDecoration(calendarItem);
    ...
    private List<DateBean> days(String sDate, String eDate) {
        ...
        try {
            ...
            LogUtil.d("startDate:" + format.format(startDate) + "----------endDate:" + format.format(endDate));
            ...
            LogUtil.d("startDateStr:" + startDateStr + "---------endDate:" + format.format(endDate));
            LogUtil.d("endDateStr:" + endDateStr + "---------endDate:" + format.format(endDate));
            ...
            for (; calendar.getTimeInMillis() <= endDate.getTime(); ) {
                ...
                LogUtil.d( "月份的开始日期:" + format.format(startMonthDay) + "---------结束日期:" + format.format(endMonthDay));
                ...
                LogUtil.d("日期" + format.format(calendar.getTime()) + "----周几" + getWeekStr(calendar.get(Calendar.DAY_OF_WEEK) + ""));
                //月份加1
